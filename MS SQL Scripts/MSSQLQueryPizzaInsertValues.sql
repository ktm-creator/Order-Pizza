...
/*MYSQL/ MS SQL DIFFERENCE: INSERT IMAGES IN MYSQL BY USING LOAD_FILE OR MANUALLY BY CHOOSING 'LOAD VALUE FROM FILE';
IN MS SQL SERVER USING THE SYNTAX- 
' * FROM OPENROWSET(BULK N'***DIRECTORY OF THE IMAGE***', SINGLE_BLOB) image'*/ 
...
INSERT INTO dbo.Delivery_Employee(EmployeeID, FName, LName, Photo) 
VALUES 
...
SELECT 2,'Arvie', 'Beetham',
	* FROM OPENROWSET(BULK N'C:\CSIS\2300\Project\step 4\data\employee1.jpg', SINGLE_BLOB) image;
...
INSERT INTO dbo.Delivery_Employee_Area(EmployeeID, DeliveryArea)
VALUES
...
/*SELECT * FROM dbo.Delivery_Employee_Area;*/

/*------TABLE CUSTOMER---------*/

INSERT INTO dbo.Customer(CustomerID, Customer_FName, Customer_LName, Email)
VALUES 
...
INSERT INTO DBO.Customer_Address(CustomerID,AddressID,HouseNumber,Street,City)
VALUES
...
INSERT INTO DBO.Pizza_Order(OrderID, DeliveryTime, DeliveryDay, CustomerID, AddressID, EmployeeID)
VALUES (1,'1:24','2021-04-10',1,1,1),
...
/*SELECT * FROM DBO.Pizza_Order;*/

/* ------TABLE DOUGH-------- */

INSERT INTO dbo.Dough (DoughID, DoughPrice, DoughName, DoughCalory)
VALUES
(1,5,'Regular',720),
(2,5,'Thin',480),
...
/*SELECT * FROM DBO.Dough;*/

/* ------TABLE SAUCE-------- */
INSERT INTO dbo.Sauce(SauceID, SaucePrice, SauceName, SauceCalory)
VALUES
(2,1,'Tomato',60),
(3,2,'Garlic',360),
(4,2,'Pesto',210),
...
/*SELECT * FROM DBO.Sauce;*/

/* ------TABLE CHEESE-------- */
INSERT INTO dbo.Cheese(CheeseID, CheesePrice, CheeseName, CheeseCalory)
VALUES
(1,0,'Mozzarella',300),
(2,1,'Dairy Free',300),
...
/*SELECT * FROM DBO.Cheese;*/

/* ------TABLE CRUST-------- */
INSERT INTO dbo.Crust(CrustID, CrustPrice, CrustName, CrustCalory)
VALUES
(1,5,'Regular',360),
(2,5,'Thin Crust',300),
...
/* ------TABLE TOPPING-------- */
INSERT INTO dbo.Topping(ToppingID, ToppingPrice, ToppingName, ToppingCalory)
VALUES
(1,1.5,'Olive',90),
(2,1.5,'Mushrooms',50),
(3,2,'Arugala',20),
...
/* ------TABLE SIZE-------- */
INSERT INTO dbo.Size(SizeID, SizePricePercentage, SizeName, SizeCaloryPercentage)
VALUES 
(1,1,'Small',1),
(2,1.3,'Medium',1.5),
(3,1.5,'Large',1.75);
...
/* ------TABLE PIZZA TYPE-------- */
INSERT INTO dbo.Pizza_Type(PizzaTypeID, Instruction, SizeID, SauceID, CrustID, CheeseID, DoughID, OrderID, NumberOfItems)
VALUES
...
/* ------TABLE PIZZA TYPE TOPPING-------- */
INSERT INTO dbo.Pizza_Type_Topping(PizzaTypeID,ToppingID) 
VALUES
(1,1), 
(1,4),
(2,3),
...
/*SELECT * FROM dbo.Pizza_Type_Topping;*/
